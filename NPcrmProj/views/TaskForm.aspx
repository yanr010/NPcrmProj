                            ...
                            <fieldset>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group"><input ng-model="data.taskName" placeholder="שם משימה" class="form-control" required="true" value="" type="text">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-2 inputGroupContainer">
                                        <div class="input-group"><input ng-model="data.finalDate" placeholder="תאריך לביצוע" class="form-control" required="true" value="" type="date"></div>
                                    </div>
                                  </div>
